...
<form action="admin_trees_config.php" class="form-horizontal" method="POST" role="form">
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="gedcom">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('Website URL'); ?>
		</label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select id="CONTACT_USER_ID" name="CONTACT_USER_ID" class="form-control">
				<?php foreach (\WT\User::allVerified() as $user): ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select id="WEBMASTER_USER_ID" name="WEBMASTER_USER_ID" class="form-control">
				<?php foreach (\WT\User::allAdmins() as $user): ?>
